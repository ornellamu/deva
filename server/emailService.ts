import { EmailLog, EmailType } from './types.js';
...
export function generateEmailContent(params: {
  ...
  const { type, applicantName, jobTitle, department, applicationId } = params;
      ...
      html: `
        ...
        <body>
          <div class="wrapper">
            ...
            <div class="body">
              <div class="status-badge">Application Accepted</div>
              <p>Dear <strong>${applicantName}</strong>,</p>
...
export async function sendApplicationEmail(params: {
  ...
  const { type, recipientEmail, recipientName, jobTitle, department, applicationId } = params;
  const emailData = generateEmailContent({ type, applicantName: recipientName, jobTitle, department, applicationId });
